...
class HrEmployee(models.AbstractModel):
    ...
    def attendance_manual(self, next_action, entered_pin=None):
        ...
        mac_address = get_mac_address() if get_mac_address() else '00:00:00:00:00:00'
        self.ensure_one()
        ...
        if can_check_without_pin or entered_pin is not None and entered_pin == self.sudo().pin:
            return self._attendance_action(latitudes, longitudes,
                                           next_action,ip_address,mac_address)
    ...
    def _attendance_action(self, latitudes, longitudes, next_action,ip_address,mac_address):
        ...
        if employee.user_id:
            modified_attendance = employee.with_user(employee.user_id).sudo()._attendance_action_change(longitudes,
                                                                                                        latitudes,ip_address,mac_address)
        else:
    ...
    def _attendance_action_change(self, longitudes, latitudes,ip_address,mac_address):
        ...
        if self.attendance_state != 'checked_in':
            vals = {
                ...
                'checkin_mac_address': mac_address,
        ...
        if attendance:
            attendance.write({
                ...
                'checkout_mac_address': mac_address,
